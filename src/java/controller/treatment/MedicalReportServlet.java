...
/**
 * MedicalReportServlet — Đã được refactor.
 *
 * Toàn bộ logic doPost() (submit phiếu khám) đã được chuyển sang:
...
public class MedicalReportServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/SubmitMedicalReportServlet").forward(request, response);
    }
    ...
    public String getServletInfo() {
        return "MedicalReportServlet — Delegates POST to SubmitMedicalReportServlet";
    }
}