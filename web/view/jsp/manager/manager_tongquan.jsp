                    ...
                    <div class="col-12 col-lg-4">
                        <div class="dashboard-card">
                            ...
                            <div class="d-grid gap-2">
                                <a href="${pageContext.request.contextPath}/view/jsp/manager/manager_danhsach.jsp" class="btn-dashboard btn-dashboard-primary w-100">
                                ...
                                <a href="${pageContext.request.contextPath}/view/jsp/manager/manager_blogs.jsp" class="btn-dashboard btn-dashboard-secondary w-100">
                                    <i class="fas fa-check-circle"></i>
                                    Duyệt blog y khoa
                                </a>
                                <a href="${pageContext.request.contextPath}/view/jsp/manager/manager_thongke.jsp" class="btn-dashboard btn-dashboard-secondary w-100">
